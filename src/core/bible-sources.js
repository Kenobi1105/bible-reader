...
export const TRANSLATIONS = {
  ...
  CUVS: { label: "CUV Simplified", name: "Chinese Union Version", language: "中文（简体）", kind: "getbible", code: "cus", direction: "ltr" },
  CUVT: { label: "CUV Traditional", name: "Chinese Union Version", language: "中文（繁體）", kind: "getbible", code: "cut", direction: "ltr" },
